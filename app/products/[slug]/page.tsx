...
`,
    ...
    "bow-rosin": {
      ...
      longDescription: `
  <p><strong>Προϊόν:</strong> Rosin No. 807 από Αυστρία</p>
  <p><strong>Κατασκευαστής:</strong> Fuzhi Musical Instrument Co., LTD</p>
  
  <p><strong>Χαρακτηριστικά:</strong></p>
  <ul>
    <li>Κατάλληλο για βιολί, βιόλα και τσέλο</li>
    <li>Υψηλής ποιότητας σύνθεση από Αυστρία</li>
    <li>Παρέχει εξαιρετική πρόσφυση στις χορδές</li>
    <li>Ομοιόμορφη κατανομή στο δοξάρι</li>
    <li>Ελαχιστοποιεί τη σκόνη κατά τη χρήση</li>
    <li>Συμπαγής κατασκευή που διαρκεί</li>
  </ul>
  
  <p><strong>Οδηγίες Χρήσης:</strong></p>
  <ul>
    <li>Εφαρμόστε το ρετσίνι ομοιόμορφα στις τρίχες του δοξαριού</li>
    <li>Μην το χρησιμοποιείτε υπερβολικά - λίγο είναι αρκετό</li>
    <li>Φυλάσσετε το σε δροσερό και ξηρό μέρος</li>
    <li>Καθαρίζετε τις χορδές από το ρετσίνι τακτικά</li>
  </ul>
  
  <p>Ιδανικό για επαγγελματίες μουσικούς και σπουδαστές, προσφέρει εξαιρετική ποιότητα ήχου και αντοχή.</p>
`,
      price: 5,
